...
import ru.yandex.practicum.filmorate.exeption.MarkNotFound;
...
public class LikesService {
    ...
    public void addLikeToFilm(long userId, long filmId, int mark) throws UserNotFound, FilmNotFound, MarkNotFound {
        if (mark > 10 || mark < 1) {
            throw new MarkNotFound("Неверное значение оценки.");
        }
